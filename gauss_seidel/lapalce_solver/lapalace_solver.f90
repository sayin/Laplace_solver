...
CALL gauss_seidel(interval,dx,dy,epsilon1,iterations,residuals,phi,res_matrix)



END PROGRAM laplace_gauss_seidel


SUBROUTINE gauss_seidel(itrvl,hx,hy,eps,iter,res,u,r)
...
INTEGER :: i,j ,ier
REAL(KIND=8), DIMENSION(0:itrvl,0:itrvl) :: u_new
REAL(KIND=8), DIMENSION(0:itrvl) :: x,y
